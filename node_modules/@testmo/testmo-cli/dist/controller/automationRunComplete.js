            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, api.appendTo(parseInt(options.runId, 10), remote_1.RemoteAutomationRunAppendTo.fromOptions(resources))];
                    case 1:
                        // Append resources to run before completing it
                        _a.sent();
                    ...
                    return [4 /*yield*/, api.complete(parseInt(options.runId, 10), remote_1.RemoteAutomationRunComplete.fromOptions(options))];
                    case 3:
                        // Complete automation run
                        _a.sent();
